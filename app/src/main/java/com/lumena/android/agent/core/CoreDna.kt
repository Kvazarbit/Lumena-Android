...
object CoreDna {
    const val VERSION = "lumena-core-v1"
    val principles = listOf(
        ...
        DnaPrinciple("E", "Докази виконання", "Require TOOL_RESULT evidence; tool success alone does not prove task completion."),
        DnaPrinciple("V", "Перевірка того самого об’єкта", "After editing, verify the same changed target before done."),
        DnaPrinciple("R", "Відновлення без зациклення", "Check failure causes; bounded retries; stop on terminal model-load failures."),
