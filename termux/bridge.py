...
class Handler(BaseHTTPRequestHandler):
    server_version = "LumenaBridge/0.12"
    ...
    def do_GET(self) -> None:
        if self.path == "/":
            self._json(200, {"ok": True, "service": "lumena-termux-bridge", "version": "0.12"})
            return
...
def main() -> None:
    print("Lumena Termux Bridge v0.12")
